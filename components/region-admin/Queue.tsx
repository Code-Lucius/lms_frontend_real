...
const QUEUE_STATUS = "submitted"; // "awaiting grading" - adjust if your DB uses a different value
  ...
  return (
    <>
      <div className="page-head">
        ...
        <h1>Grading queue</h1>
        <p>Exercises submitted by parishioners across your region, awaiting your review.</p>
      </div>
